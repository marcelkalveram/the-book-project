...
<body itemscope itemtype="http://schema.org/Product">
	...
	<!-- MASTHEAD -->
	<header id="masthead" class="votehead">
		...
		<div class="bg-image-container <?php echo $this->fetch('bg-image-class'); ?>">
			...
			<figure class="logo">
				<?php echo $this->Html->link(
				    $this->Html->image('the-book-project-logo.png', array('alt' => 'Logotipo del proyecto', 'itemprop' => 'image')),
				    array('controller' => 'proposals', 'action' => 'index'),
				    array('escape' => false)
				);?>
		  		<figcaption>
